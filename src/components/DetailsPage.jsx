...
if(userRegister){
  ...
  if(userIdFormat && userIdFormat.user_id){
    const data = {
      ...
      deliveryAddress,
      state,
      total_amount: totalProductAmount || productDetails.final_price,
    };
    ...
    try {
      ...
      const options = {
        ...
        amount:  productDetails.cart_details?.total_amount * 100 || productDetails.final_price * 100,
        currency: "INR",
        name: name,
  ...
  return (
    <>
      <div className="max-w-lg mx-auto p-4 border border-gray-300 rounded-md shadow-md mt-10 bg-blue-500">
      <ToastContainer />
        ...
        />
          ...
          <div>
            ...
            <input
              type="number"
              id="totalAmount"
              value={totalProductAmount || productDetails.final_price}
              onChange={(e) => setTotalAmount(e.target.value)}
              required
              className="w-full px-4 py-2 border border-gray-300 font-bold rounded-md focus:outline-none focus:ring-blue-500"
            />
          </div>
          ...
          <div className="text-center">
            <button
              ...
              className={`flex items-center px-4 py-2 ${
                paymentLoading ? "bg-gray-400" : "bg-green-500"
